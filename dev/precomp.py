...
# One file per E-series: rcf_e12.bin, rcf_e24.bin, rcf_e96.bin
#
...
E24_BASE_VALUES = [1.0, 1.1, 1.2, 1.3, 1.5, 1.6, 1.8, 2.0, 2.2, 2.4, 2.7, 3.0,
                   3.3, 3.6, 3.9, 4.3, 4.7, 5.1, 5.6, 6.2, 6.8, 7.5, 8.2, 9.1]
E96_BASE_VALUES = [1.00, 1.02, 1.05, 1.07, 1.10, 1.13, 1.15, 1.18, 1.21, 1.24, 1.27, 1.30,
...
def main():
    # Safety: ensure little-endian host (Windows). If not, we still write little-endian header,
    # but array.tofile uses native endianness. On non-LE hosts, consider rewriting using struct.pack.
    ...
    generate_series_file(12, E12_BASE_VALUES, out_e12)
    generate_series_file(24, E24_BASE_VALUES, out_e24)
    generate_series_file(96, E96_BASE_VALUES, out_e96)
